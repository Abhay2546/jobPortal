...
<style>
	...
	.p0 {padding:0}
	.job-icon{margin: 8px 0;width: 50px;height: 50px;background: #039ac7;color: #fff;font-size: 200%;text-align: center;padding: 2px 3px;text-shadow: 1px 1px 1px #737373;}
					...
					<div class='col-sm-10 col-lg-11'>
						<div>
							...
							<div class='p0 col-sm-12 col-md-12'>
								...
								<div class='p0 job-salary col-sm-5 col-md-9 col-lg-10'><i class='fa1 fa fa-rupee'></i><?=$salary_min?> - <?=$salary_max?></div>
